  ...
  return (
    <div className="min-h-screen bg-slate-50 flex flex-col">
      <div className="border-b border-slate-200 bg-white">
        <div className="max-w-6xl mx-auto px-3 sm:px-6 lg:px-8 py-3 sm:py-4 flex items-center justify-between gap-3">
      ...
      <div className="flex-1 max-w-6xl mx-auto w-full px-3 sm:px-6 lg:px-8 py-3 sm:py-6">
        <motion.div
        ...
        >
          ...
          <Tabs defaultValue="overview" className="w-full">
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 mb-4">
              <TabsList className="bg-slate-100 w-full sm:w-auto overflow-x-auto rounded-full p-1 flex">
                <TabsTrigger value="overview" className="gap-1.5 text-xs sm:text-sm px-3 sm:px-4 py-2 sm:py-2.5 whitespace-nowrap flex-1 sm:flex-none">
                  <Activity className="w-3.5 h-3.5" />
                  Overview
                </TabsTrigger>
                <TabsTrigger value="digestion" className="gap-1.5 text-xs sm:text-sm px-3 sm:px-4 py-2 sm:py-2.5 whitespace-nowrap flex-1 sm:flex-none">
                  <Utensils className="w-3.5 h-3.5" />
                  Digestion
                </TabsTrigger>
                <TabsTrigger value="mental" className="gap-1.5 text-xs sm:text-sm px-3 sm:px-4 py-2 sm:py-2.5 whitespace-nowrap flex-1 sm:flex-none">
